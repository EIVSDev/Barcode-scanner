    ...
    public void onBindViewHolder(@NonNull final ProductViewHolder productViewHolder, int i) {
        ...
        productViewHolder.itemView.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() {
            ...
            public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
                ...
                contextMenu.add(productViewHolder.getAdapterPosition(), 1, 0, "Добавить");
                contextMenu.add(productViewHolder.getAdapterPosition(), 2, 0, "Изменить текст");
                contextMenu.add(productViewHolder.getAdapterPosition(), 3, 0, "Изменить изображение");
            }
        });
    }
